...
export const conversationMessagesByTicketId: Record<string, ConversationMessage[]> = {
  'ticket-1001': [
    {
      id: 'msg-1001-1',
      direction: 'INBOUND',
...
export function findConversationTicket(ticketId: string) {
  return conversationTickets.find((ticket) => ticket.id === ticketId);
}
